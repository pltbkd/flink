...
public class FileWriter<IN>
    ...
    private final BucketInspectionTimerCallback callback = new BucketInspectionTimerCallback();
    ...
    @Override
    public List<FileSinkCommittable> prepareCommit() throws IOException {
    ...
    private void registerNextBucketInspectionTimer() {
        ...
        processingTimeService.registerTimer(nextInspectionTime, callback);
    }
    ...
    private class BucketInspectionTimerCallback
