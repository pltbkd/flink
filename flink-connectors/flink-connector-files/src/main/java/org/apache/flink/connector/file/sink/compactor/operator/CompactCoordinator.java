...
public class CompactCoordinator extends AbstractStreamOperator<FileCompactRequest>
    ...
    private final FileCompactRequestPacker packer;
    private final SimpleVersionedSerializer<FileSinkCommittable> committableSerializer;

    private ListState<CommittableMessage<FileSinkCommittable>> remainingCommittableState;

    public CompactCoordinator(
            FileCompactRequestPacker packer,
    ...
    public void initializeState(StateInitializationContext context) throws Exception {
        ...
        Iterable<CommittableMessage<FileSinkCommittable>> stateRemaining =
                remainingCommittableState.get();
        if (stateRemaining != null) {
            for (CommittableMessage<FileSinkCommittable> committable : stateRemaining) {
