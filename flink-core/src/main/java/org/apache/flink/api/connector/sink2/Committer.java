...
public interface Committer<CommT> extends AutoCloseable {
    ...
    interface CommitRequest<CommT> {
        ...
        /**
         * The commit failed for known reason and should not be retried. Depending on the sink
         * configuration this will fail the job.
         */
        void failedWithKnownReason();

        /**
         * The commit failed for unknown reason and should not be retried. Depending on the sink
         * configuration this will fail the job.
         */
        void failedWithUnknownReason();
