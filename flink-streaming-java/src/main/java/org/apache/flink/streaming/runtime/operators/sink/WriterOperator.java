 ...
 */
class WriterOperator<InputT, CommT> extends AbstractStreamOperator<CommittableMessage<CommT>>
    ...
    private final boolean emitOnEndOfInput;
    ...
    WriterOperator(
            ...
            boolean emitOnEndOfInput) {
        this.emitOnEndOfInput = emitOnEndOfInput;
