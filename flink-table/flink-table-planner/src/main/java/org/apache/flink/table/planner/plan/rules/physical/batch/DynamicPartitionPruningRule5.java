...
/** DynamicPartitionPruningRule5. */
public class DynamicPartitionPruningRule5 extends DynamicPartitionPruningRuleBase {

    public static final RelOptRule FACT_IN_RIGHT =
            DynamicPartitionPruningRule5.Config.EMPTY
                    .withDescription("DynamicPartitionPruningRule5:factInRight")
                    .as(Config.class)
                    .factInRight()
                    .toRule();

    public DynamicPartitionPruningRule5(RelRule.Config config) {
        super(config);
    }
    ...
    public interface Config extends RelRule.Config {
        @Override
        default DynamicPartitionPruningRule5 toRule() {
            return new DynamicPartitionPruningRule5(this);
        }
