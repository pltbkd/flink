...
/** DynamicPartitionPruningRule3. */
public class DynamicPartitionPruningRule3 extends DynamicPartitionPruningRuleBase {

    public static final RelOptRule FACT_IN_RIGHT =
            DynamicPartitionPruningRule3.Config.EMPTY
                    .withDescription("DynamicPartitionPruningRule3:factInRight")
                    .as(Config.class)
                    .factInLeft()
                    .toRule();

    public DynamicPartitionPruningRule3(RelRule.Config config) {
        super(config);
    }
    ...
    public interface Config extends RelRule.Config {
        @Override
        default DynamicPartitionPruningRule3 toRule() {
            return new DynamicPartitionPruningRule3(this);
        }
