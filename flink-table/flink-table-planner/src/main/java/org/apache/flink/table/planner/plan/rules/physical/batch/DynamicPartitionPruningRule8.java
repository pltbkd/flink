...
/** DynamicPartitionPruningRule8. */
public class DynamicPartitionPruningRule8 extends DynamicPartitionPruningRuleBase {

    public static final RelOptRule FACT_IN_LEFT =
            DynamicPartitionPruningRule8.Config.EMPTY
                    .withDescription("DynamicPartitionPruningRule8:factInLeft")
                    .as(Config.class)
                    .factInLeft()
                    .toRule();

    public DynamicPartitionPruningRule8(RelRule.Config config) {
        super(config);
    }
    ...
    public interface Config extends RelRule.Config {
        @Override
        default DynamicPartitionPruningRule8 toRule() {
            return new DynamicPartitionPruningRule8(this);
        }
    ...
    public boolean matches(RelOptRuleCall call) {
        ...
        final BatchPhysicalCalc calc = call.rel(5);
    ...
    public void onMatch(RelOptRuleCall call) {
        ...
        final BatchPhysicalTableSourceScan factScan = call.rel(3);
        final RelNode dimSide = call.rel(4);
